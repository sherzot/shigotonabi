        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>〒163-0825
                        東京都新宿区西新宿２丁目４番１号新宿ＮＳビル２５階</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>03-5909-4120</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>lis21@gmail.com</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                ...
                <img src="{{ asset('images/shigotonavi.svg') }}" width="150" alt="Logo">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="index.html" class="nav-item nav-link active">しごとを探す</a>
                    <a href="about.html" class="nav-item nav-link">リンク</a>
                    <a href="service.html" class="nav-item nav-link">学ぶ</a>
                    <a href="package.html" class="nav-item nav-link">採用企業</a>
                    <a href="contact.html" class="nav-item nav-link">お問い合わせ</a>
                </div>
                <a href="" class="btn btn-primary rounded-pill py-2 px-4 mx-3">会員登録</a>
                <a href="" class="btn btn-primary rounded-pill py-2 px-4">ログイン</a>
            </div>
        </nav>
                ...
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <div class="header-text-top">
                            <h1 class="display-3 text-white mb-3 animated slideInDown">仕事を探す ｜ 転職活動の基本機能</h1>
                        <p class="fs-4 text-white mb-4 animated slideInDown">「しごとを探す」エリアでは、基本機能の求人情報検索のほか、履歴の自動作成やコンビニプリント機能などがご利用できる、「しごとナビ」が誇る適職に就くためのお役立ち情報が満載です。</p>
                        </div>
                        <div class="welcome-hero-serch-box">
                            <div class="welcome-hero-form">
                                <div class="single-welcome-hero-form">
                                    <form action="index.html">
                                        <input type="text" placeholder="仕事の名前から探す" />
                                    </form>
                                ...
                                <div class="single-welcome-hero-form">
                                    <form action="index.html">
                                        {{-- <input type="text" placeholder="エリアから探す" /> --}}
                                        <select class="custom-select" id="inputGroupSelect01">
                                            <option selected>エリアから探す...</option>
